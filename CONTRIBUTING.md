...
///
/// ```
/// use platform_data::example_function;
...
- Get support on [Discord](https://discord.gg/eEXJyjWv5e)
- Ask questions at [stackoverflow.com/tags/links-platform](https://stackoverflow.com/tags/links-platform)
